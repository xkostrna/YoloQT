...
#if QT_CONFIG(tooltip)
        self.spinBoxMaxDet_2.setToolTip(QCoreApplication.translate("MainWindow", u"max_det", None))
#endif // QT_CONFIG(tooltip)
        self.labelIoU_2.setText(QCoreApplication.translate("MainWindow", u"Intersection over union", None))
#if QT_CONFIG(tooltip)
        self.comboBoxDevice_3.setToolTip(QCoreApplication.translate("MainWindow", u"device", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.doubleSpinBoxConf_2.setToolTip(QCoreApplication.translate("MainWindow", u"conf", None))
#endif // QT_CONFIG(tooltip)
        self.labelMaxDet_2.setText(QCoreApplication.translate("MainWindow", u"Maximum number of detections", None))
#if QT_CONFIG(tooltip)
        self.doubleSpinBoxIoU_2.setToolTip(QCoreApplication.translate("MainWindow", u"iou", None))
#endif // QT_CONFIG(tooltip)
